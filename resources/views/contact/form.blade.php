...
<body>
  <div class="insolate bg-white overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      ...
      <p class="mt-2 text-lg leading-8 text-gray-600">Envia tu mensaje o queja,que nuestro equipo se comunicara contigo lo antes posible.</p>
    </div>
      ...
      @csrf
        ...
        <div class="sm:col-span-2">
          ...
          {{-- <div class="relative mt-2.5">
            ...
            <input type="tel" name="phone_number" id="phone_number" autocomplete="tel" class="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>


        <div class="sm:col-span-2">
            <label for="affair" class="block text-sm font-semibold leading-6 text-gray-900">Asunto</label>
            <div class="mt-2.5">
              <input type="text" name="affair" id="affair" autocomplete="affair" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
