...
<nav id="header" class="w-full z-30 top-0 py-1">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
        ...
        <div class="order-2 md:order-3 flex items-center relative z-30" id="nav-content">
            @auth
             <a class="inline-block no-underline hover:text-black mr-5" href="{{route('cart.index')}}">
                ...
                <div class="relative group">
                    <a class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl group-hover:text-black" href="#">
                        <svg class="fill-current text-gray-800 mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <ul class="absolute hidden text-gray-700 pt-1 group-hover:block">
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4 bg-white w-full " href="{{ route('profile.edit') }}">Perfil</a></li>
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4 bg-white w-full " href="{{ route('addresses.index') }}">Mis Direcciones</a></li>
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="inline-block no-underline hover:text-black hover:underline py-2 px-4 bg-white w-full">
                                Cerrar sesión
                                </button>
                            </form>
                        </li>
